...
export class Sitting extends State {
    ...
    handleInput(input){
        ...
        else if(input.includes('Enter') && this.game.player.rollingTimer < this.game.player.rollingLimit){
...
export class Diving extends State {
    ...
    handleInput(input){
        ...
        else if(input.includes('Enter') && this.game.player.onGround() && this.game.player.rollingTimer < this.game.player.rollingLimit){
            this.game.player.setState(states.ROLLING, 2);
        }
    }
}
