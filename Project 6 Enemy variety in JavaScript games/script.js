window.addEventListener('load', function(){
    ...
    class Game {
        ...
        // # make the function a private class thus only class Game can call it
        #addNewEnemy(){
    ...
    class Worm extends Enemy {
        constructor(game){
            ...
            this.sizeModifier = Math.random() * 0.8 + 2;
    ...
    class Spider extends Enemy {
        constructor(game){
            ...
            this.maxLength = Math.random() * (this.game.height /2) + this.height;
        }
        update(deltaTime){
            super.update(deltaTime);
